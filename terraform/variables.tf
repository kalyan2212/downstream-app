...
variable "vm_size" {
  description = "Azure VM size for both app and DB VMs"
...
variable "replication_password" {
  ...
  sensitive   = true
  default     = ""   # generated randomly if blank; overridden in workflow
}
...
variable "availability_zone" {
  description = "Azure Availability Zone to deploy all resources into"
  default     = "1"
}
